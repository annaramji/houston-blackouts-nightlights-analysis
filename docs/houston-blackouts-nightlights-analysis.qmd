...
ggsave(filename = "income_dist_plot_impacted.png", plot = impacted_plot,
       path = here("figs"), width = 10, height = 6)

ggsave(filename = "income_dist_plot_unimpacted.png", plot = unimpacted_plot,
       path = here("figs"), width = 10, height = 6)
```
